...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) 
    {
        ...
        // backgound
        UIImageView *bacground = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
        UIImage *image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"pickerBackground" ofType:@"png"]];
        bacground.image = image;
        ...
        // shadows
        UIImageView *shadows = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
        UIImage *image2 = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"pickerShadows" ofType:@"png"]];
        shadows.image = image2;
        [self addSubview:shadows];
        
        // glass
        UIImage *glassImage = [[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"pickerGlass" ofType:@"png"]];
